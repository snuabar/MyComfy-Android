...
public class ImageResponse {
    ...
    public List<String> getImage_paths() { return image_paths; }
    public void setImage_paths(List<String> image_paths) { this.image_paths = image_paths; }
    ...
    public Float getProcessing_time() { return processing_time; }
    public void setProcessing_time(Float processing_time) { this.processing_time = processing_time; }
}
